        ...
        <section className="spacing-secton py-8 sm:py-14 text-gray-800">
            ...
            <section>
                ...
                <p className="text-lg leading-relaxed mt-6">
                    ...
                    mindsees Technologies., a Pakistan based software house with its principal place of business at 56 F2,
                    ...
                    <br /><br />
                    “Website” refers to mindsees, accessible from
                    <span className="text-[#00D280]">www.mindsees.com</span>
                    <br /><br />
            ...
            <section className="mt-10">
                ...
                <p className="mt-8 text-lg">mindsees may use your personal data for the following purposes:</p>
            ...
            <section className="mt-10">
                ...
                <p className="mt-8 text-lg">During negotiations or in connection with any merger, sale of assets, financing, or acquisition involving mindsees.</p>
            ...
            <section className="mb-10">
                ...
                <p className="mb-4 text-lg leading-relaxed">
                    Your data may be transferred if mindsees is involved in mergers, acquisitions, or sales.
                </p>
                ...
                <ul className="text-lg leading-relaxed list-decimal ml-6 space-y-2">
                    ...
                    <li>Protect mindsees rights or property</li>
            ...
            <section>
                ...
                <ul className="leading-relaxed text-lg space-y-1 mt-4 list-none">
                    <li className="mt-6">
                        By email
                        <a href="mailto:info@mindsees.com.com" className="text-[#00D280] ml-2" >info@mindsees.com</a>
                    </li>
                    <li className="mt-6">
                        By visiting
