        ...
        <>
            <section className="spacing-secton py-8 sm:py-14 text-gray-800">
                ...
                <section className="mt-10">
                    <h2 className="text-4xl font-semibold mt-14">Intellectual Property</h2>
                    <p className="mt-8 text-lg">
                        All content and materials on this website, including but not limited to text, graphics, logos, images, and software, are the intellectual property of Kavelogics or its licensors. You may not reproduce, distribute, or create derivative works from any of the content without explicit permission.
                    </p>


                    <h2 className="text-4xl font-semibold mt-14">User Accounts</h2>
                    <p className="mt-8 text-lg">
                    ...
                    <h2 className="text-4xl font-semibold mt-14">User Content</h2>
                    <p className="mt-8 text-lg">
                        Users may have the opportunity to post content, such as comments and reviews, on our website. Kavelogics does not pre-screen, edit, or endorse user content and is not responsible for any user-generated content. By posting content, you grant Kavelogics a non-exclusive, royalty-free, perpetual, and worldwide license to use, reproduce, modify, and distribute your content in any media.
                    </p>



                    <h2 className="text-4xl font-semibold mt-14">Limitation of Liability</h2>
                    <p className="mt-8 text-lg">
                        To the fullest extent permitted by law, Kavelogics, its affiliates, and their respective directors, employees, and agents shall not be liable for any indirect, incidental, special, consequential, or punitive damages, or any loss of profits or revenues, whether incurred directly or indirectly, or any loss of data, use, goodwill, or other intangible losses resulting from your use of the website or services.
                    </p>



                    <h2 className="text-4xl font-semibold mt-14">Indemnification</h2>
                    <p className="mt-8 text-lg">
                        You agree to indemnify and hold Kavelogics, its affiliates, and their respective directors, employees, and agents harmless from any claims, damages, losses, liabilities, and expenses (including legal fees) arising from your use of the website or services, your violation of these terms, or your infringement of any third-party rights.
                    </p>




                    <h2 className="text-4xl font-semibold mt-14">Governing Law</h2>
                    <p className="mt-8 text-lg">
                    ...
                    <h2 className="text-4xl font-semibold mt-14">Modifications to Terms</h2>
                    <p className="mt-8 text-lg">
                        Kavelogics reserves the right to revise these terms at any time. Your continued use of the website and services after the new terms take effect constitutes your acceptance of the new terms.
                    </p>
                </section>
                <section>
