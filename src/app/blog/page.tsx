...
function Page() {
  const workName=[
    {
    title:"Development",
    description:"Explore in-depth guides for developers and stay updated with the latest tech insights, all curated by expert engineers from the MindSees community.",
    image:"",
    hoverTitle:"Read Development Articles"
  },
    {
    title:"Design",
    description:"Explore advanced design topics with detailed tutorials and in-depth coverage of cutting-edge design techniques and technologies.",
  image:"",
    hoverTitle:"Read Design Articles"
  },
    {
    title:"Marketing",
    description:"The MindSees Marketing Blog highlights the newest tools, strategies, and techniques, offering expert insights to keep you ahead in the ever-evolving world of marketing.",
  image:"",
    hoverTitle:"Read Marketing Articles"
  },
    {
    title:"Finance",
    description:"Your go-to source for financial insights, covering capital-raising strategies, emerging market trends, and the latest in financial technology.",
  image:"",
    hoverTitle:"Read Finance Articles"
  },
    {
    title:"Industries",
    description:"Discover how our solutions fuel success in industries such as healthcare, finance, and retail through tailored, innovative strategies.",
  image:"",
    hoverTitle:"Read Industries Articles"
  },
    {
    title:"Business",
    description:"Discover strategies and insights designed to help businesses grow, featuring innovative solutions and practical guidance for tackling challenges.",
  image:"",
