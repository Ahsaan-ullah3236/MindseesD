...
export default function SuccessStoriesPage() {
  ...
  />
      ...
      <button 
        onClick={prevSlide}
        className="absolute left-[34%] md:left-[40%]  lg:left-[45%] 2xl:left-[48%] -bottom-2 -translate-y-1/2 bg-[#00d280] cursor-pointer p-3 rounded-full shadow-md  z-10"
      ...
      <button 
        onClick={nextSlide}
        className="absolute right-[34%] md:right-[40%] lg:right-[45%] 2xl:right-[48%] -bottom-2 -translate-y-1/2 bg-[#00d280] cursor-pointer p-3 rounded-full shadow-md  z-10"
