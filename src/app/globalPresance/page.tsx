          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="space-y-8 ">
              ...
              <div className="pt-6">
                ...
                <a href="mailto:info@kavelogies.com" className=" text-blue-400 hover:text-blue-500" style={{fontSize:"13px"}}>
                  info@mindsees.com
                </a>
            ...
            <div className="lg:pl-8 -pt-6 lg:pt-0">
                <Image src={LahoreOffice} alt="lahore-office" height={200} width={260} className="mx-auto" />
            ...
            <div className="lg:pl-8 -pt-6 lg:pt-0">
                <Image src={USAOffice} alt="USA-office" height={200} width={260} className="mx-auto"/>
