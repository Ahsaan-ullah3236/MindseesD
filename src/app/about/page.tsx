        ...
        <div >
            ...
            <div className="py-30 max-w-7xl mx-auto ">
                <div className="spacing-secton flex flex-col md:flex-row items-center justify-between gap-20 px-4">
                    ...
                    <div className="md:w-1/2">
                        <h2 className="text-5xl  font-bold text-[#002f46] mb-5">Who We Are?</h2>
            ...
            <div className="bg-[#023047] max-w-4xl mx-auto flex w-full rounded-2xl shadow-xl">
                <div className=" flex flex-col md:flex-row items-center gap-12 ">
                    ...
                    <div className="md:w-2/2 text-white text-center md:text-left px-16 ">
                        <h2 className="text-5xl font-bold mb-5 mt-4">Our Mission</h2>
                        <p className="text-[19px] pb-6" style={{lineHeight:"25px"}}>
            ...
            <div className="main-container max-w-5xl mx-auto flex justify-center items-center text-center py-12 px-4">
                <div className="inner-container">
                    <h1 className="text-5xl text-[#023047] font-bold mt-14 mb-16">Our Values</h1>
            ...
            <div className="bg-[#002f46]  py-28 mt-16 spacing-secton">
                    ...
                    <h1 className="text-4xl text-white font-bold mb-6 capitalize" style={{ fontFamily: 'Poppins, sans-serif' }}>
