...
function page() {
  return (
     <section className="spacing-secton py-8 sm:py-14 text-gray-800">
            <h1 className="text-3xl sm:text-5xl font-semibold sm:text-bold mb-4">Cookie Policy </h1>
            <section>
                ...
                <h2 className="text-3xl sm:text-5xl font-semibold sm:text-bold mt-10">How We Use Cookies?</h2>
                <p className="text-lg leading-relaxed mt-6">
            ...
            <section className="mt-10">
                ...
                <h2 className="text-2xl sm:text-4xl font-semibold sm:text-bold mt-10">2. Performance Cookies</h2>
                <p className="mt-8 text-lg">
                ...
                <h2 className="text-2xl sm:text-4xl font-semibold sm:text-bold mt-10">3. Functionality Cookies</h2>
                <p className="mt-8 text-lg">
                ...
                <h2 className="text-2xl sm:text-4xl font-semibold sm:text-bold mt-10">4. Targeting Cookie</h2>
                <p className="mt-8 text-lg">
            ...
            <section className="mt-10">
                <h1 className="text-3xl sm:text-5xl font-semibold sm:text-bold mt-16">Types of Cookies We Use
                </h1>
                <h1 className="text-2xl sm:text-4xl font-semibold sm:text-bold mt-10">1. Session Cookies
                </h1>
                <p className="mt-8 text-lg">These are temporary cookies that expire when you close your browser.</p>

                <h2 className="text-2xl sm:text-4xl font-semibold sm:text-bold mt-10">2. Persistent Cookies</h2>
                <p className="mt-8 text-lg">
                ...
                <h2 className="text-2xl sm:text-4xl font-semibold sm:text-bold mt-10">3. Third-Party Cookies </h2>
                <p className="mt-8 text-lg">
                ...
                <h2 className="text-2xl sm:text-4xl font-semibold sm:text-bold mt-10">4. Managing Cookies</h2>
                <p className="mt-8 text-lg">
            ...
            <section>
                <h1 className="text-3xl sm:text-5xl font-semibold sm:text-bold mt-16">Changes to This Cookie Policy</h1>
            ...
            <section>
                <h1 className="text-3xl sm:text-5xl font-semibold sm:text-bold mt-16">Contact Us</h1>
