    ...
    <div className="spacing-secton pb-20 mx-auto ">
      ...
      <div 
        ...
        {CustomWhyChoose.map((item, index) => (
          <div key={index}  style={{ flex: "0 0 auto" }}  className="w-full sm:w-[48%] md:w-[48%] lg:w-[30%] xl:w-[31%] 2xl:w-[23%] value-card mx-2 p-2 mb-13 bg-[#d6f1ff] pb-12 pt-5 rounded-md hover:border-[1px] hover:border-[#013a54]">
            <div>
